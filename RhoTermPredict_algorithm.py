...
def rhoterm_predict(input_file, predict_file, info_file):
    ...
    try:
        ...
        for sq in sequences_to_analyze:
            ...
            predictions_file = open(predict_file, mode='a')
        ...
        print(f"File {input_file} not existent in the current directory!")

@click.command()

@click.option('--input_file', required = True, help = "Input file")
@click.option('--predictions_file', required = True, help = "Predictions file")
@click.option('--info_file', required = True, help = "Infor file")


def main(input_file, predictions_file, info_file):
    rhoterm_predict(input_file=input_file, predict_file=predictions_file, info_file=info_file)
